 ...
 */
var PopoverOptionsPage = /** @class */ (function () {
    function PopoverOptionsPage(navCtrl, navParams, popoverCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.popoverCtrl = popoverCtrl;
    }
    PopoverOptionsPage.prototype.ionViewDidLoad = function () {
